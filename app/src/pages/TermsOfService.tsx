    ...
    <div className="pt-32 pb-20 bg-parchment">
      ...
      <div className="section-container max-w-4xl">
        ...
        <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-parchment-dark prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-display text-ink mt-8 mb-4">5. Grievance Redressal</h2>
          <p className="text-mutedgray">For any complaints, grievances, or disputes arising out of these Terms, please contact our Grievance Officer:</p>
          <ul className="text-mutedgray space-y-1 mt-3 text-sm">
            <li><strong>Name:</strong> Siddhant Kuwad</li>
            <li><strong>Designation:</strong> Founder</li>
          ...
          <p className="text-mutedgray mt-3">We are committed to addressing your concerns promptly and fairly.</p>
        </div>
      </div>
    </div>
  );
