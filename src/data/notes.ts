...
export const notesData: Note[] = [
  ...
  { 
    id: 3, 
    title: "BNSS Complete Notes", 
    slug: "bnss-complete-notes",
    description: "Bharatiya Nagarik Suraksha Sanhita 2023 notes covering criminal procedure, bail, trial procedures, and appeals.",
    category: "Criminal Law", 
    ...
    pdfUrl: "/pdfs/bnss-complete.pdf",
    isFeatured: true,
    isNew: true,
    language: 'English',
    tableOfContents: ["Introduction to BNSS", "Arrest & Bail", "Investigation", "Trials", "Appeals & Revisions"],
    createdAt: "2024-01-15"
  },
  { 
    id: 4, 
...
export const categories: Category[] = [
  ...
  { id: "10", name: "Criminal Procedure", slug: "criminal-procedure", icon: "ClipboardList", color: "#991B1B", description: "CrPC and BNSS procedures", noteCount: 1 },
